...
SkoarTokeInspector::SkoarTokeInspector() : table({
    ...
    { ESkoarToke::ListSep, SpellOfToking{
        auto x = make_shared<SkoarpuscleListSep>();
        noad->skoarpuscle = x;
        noad->toke = nullptr;
    } },

    { ESkoarToke::ListE, SpellOfToking{
