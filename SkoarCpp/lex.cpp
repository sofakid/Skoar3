// ======================================================================
// lex.cpp - Generated by Code_Cpp_Lexer on 2017-04-22 08:35:19 for C++14
// ======================================================================
#include "lex.hpp"
...
const std::wregex Toke_AlCoda::rgx = wregex(L"al [cC]oda(\\s*:\\s*[a-zA-Z0-9_]+)?");
...
const std::wregex Toke_Coda::rgx = wregex(L"\\([+]\\)(\\s*:\\s*[a-zA-Z0-9_]+)?");
...
const std::wregex Toke_Int::rgx = wregex(L"(-)?(0|[1-9][0-9]*)(?![0-9]*Hz|[0-9]*\\.[0-9]|:[0-9])");
