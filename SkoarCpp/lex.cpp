// ======================================================================
// lex.cpp - Generated by Code_Cpp_Lexer on 2017-04-13 16:04:30 for C++14
// ======================================================================
#include "lex.hpp"
...
const std::wregex Toke_AlCoda::rgx = wregex(L"al(la)? [cC]oda(\\s*:\\s*[a-zA-Z0-9_]+)?");
...
const std::wregex Toke_AlFine::rgx = wregex(L"al [fF]ine");
...
const std::wregex Toke_AlSegno::rgx = wregex(L"al [sS]egno(\\s*:\\s*[a-zA-Z0-9_]+)?");
...
const std::wregex Toke_Choard::rgx = wregex(L"~*[ABCDEFG](?![.ce-hj-ln-rt-zA-LN-Z]|a[l ])(#|b)?([Mm0-9]|sus|dim|aug|dom)*~*");
...
const std::wregex Toke_Coda::rgx = wregex(L"(\\([+]\\)|[cC]oda)(\\s*:\\s*[a-zA-Z0-9_]+)?");
...
const std::wregex Toke_DalSegno::rgx = wregex(L"(D\\.S\\.|Dal Segno)(\\s*:\\s*[a-zA-Z0-9_]+)?");
...
const std::wregex Toke_Fine::rgx = wregex(L"[fF]ine");
...
const std::wregex Toke_Segno::rgx = wregex(L"[sS]egno(\\s*:\\s*[a-zA-Z0-9_]+)?");
...
const std::wregex Toke_SymbolColon::rgx = wregex(L"([sS](?!egno\\s*:)|[a-rt-zA-RT-Z_])[a-zA-Z0-9_]*[ \\t]*:(?![:|}])");
