// ======================================================================
// lex.cpp - Generated by Code_Cpp_Lexer on 2017-05-05 22:10:04 for C++14
// ======================================================================
#include "lex.hpp"
...
const std::wregex Toke_BooleanOp::rgx = wregex(L"==|!=|<=|>=|and|or|xor", regex_constants::optimize);
...
const std::wregex Toke_DynFP::rgx = wregex(L"fp(?![a-oq-zA-Z0-9_])", regex_constants::optimize);
...
const std::wregex Toke_DynForte::rgx = wregex(L"m(ezzo)?f(orte)?|f+orte|ff+(?![a-oq-zA-Z0-9_])", regex_constants::optimize);
...
const std::wregex Toke_DynPiano::rgx = wregex(L"(m(ezzo)?p|p+)(iano)?(?![a-oq-zA-Z0-9_])", regex_constants::optimize);
...
const std::wregex Toke_DynSFZ::rgx = wregex(L"sfz(?![a-oq-zA-Z0-9_])", regex_constants::optimize);
...
const std::wregex Toke_KUGen::rgx = wregex(L"k[A-Z][a-zA-Z0-9_]*(?![a-zA-Z0-9_]*<)", regex_constants::optimize);
...
const std::wregex Toke_KUGenWithArgs::rgx = wregex(L"k[A-Z][a-zA-Z0-9_]*<", regex_constants::optimize);
...
const std::wregex Toke_MathOp::rgx = wregex(L"[+*\\-/%](?!>)", regex_constants::optimize);
...
const std::wregex Toke_SkoarpionSep::rgx = wregex(L"!!", regex_constants::optimize);
...
const std::wregex Toke_SkoarpionStartWithSig::rgx = wregex(L"[{]!(?=([^!](?!![}]))*!!)", regex_constants::optimize);
