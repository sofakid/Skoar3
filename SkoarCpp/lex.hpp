...
public:
    ...
    static     Toke_QuindicesimaB * instance();
     ...
     Toke_QuindicesimaB();
     Toke_QuindicesimaB(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_QuindicesimaA * instance();
     ...
     Toke_QuindicesimaA();
     Toke_QuindicesimaA(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_AlFine * instance();
     ...
     Toke_AlFine();
     Toke_AlFine(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_Newline * instance();
     ...
     Toke_Newline();
     Toke_Newline(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_Tuplet * instance();
     ...
     Toke_Tuplet();
     Toke_Tuplet(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_DynForte * instance();
     ...
     Toke_DynForte();
     Toke_DynForte(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_LoopSep * instance();
     ...
     Toke_LoopSep();
     Toke_LoopSep(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_CondIf * instance();
     ...
     Toke_CondIf();
     Toke_CondIf(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_MsgNameWithArgs * instance();
     ...
     Toke_MsgNameWithArgs(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_DynSFZ * instance();
     ...
     Toke_DynSFZ();
     Toke_DynSFZ(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_SkoarpionSep * instance();
     ...
     Toke_SkoarpionSep();
     Toke_SkoarpionSep(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_OctaveShift * instance();
     ...
     Toke_OctaveShift();
     Toke_OctaveShift(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_NamedNoat * instance();
     ...
     Toke_NamedNoat();
     Toke_NamedNoat(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_DaCapo * instance();
     ...
     Toke_DaCapo();
     Toke_DaCapo(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_String * instance();
     ...
     Toke_String();
     Toke_String(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_SkoarpionEnd * instance();
     ...
     Toke_SkoarpionEnd();
     Toke_SkoarpionEnd(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_SkoarpionStart * instance();
     ...
     Toke_SkoarpionStart();
     Toke_SkoarpionStart(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_Comment * instance();
     ...
     Toke_Comment();
     Toke_Comment(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_Eighths * instance();
     ...
     Toke_Eighths();
     Toke_Eighths(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_SymbolName * instance();
     ...
     Toke_SymbolName();
     Toke_SymbolName(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_Quavers * instance();
     ...
     Toke_Quavers();
     Toke_Quavers(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_Portamento * instance();
     ...
     Toke_Portamento();
     Toke_Portamento(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_PedalDown * instance();
     ...
     Toke_PedalDown();
     Toke_PedalDown(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_Semicolon * instance();
     ...
     Toke_Semicolon();
     Toke_Semicolon(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_AlCoda * instance();
     ...
     Toke_AlCoda();
     Toke_AlCoda(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_Carrot * instance();
     ...
     Toke_Carrot();
     Toke_Carrot(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_DalSegno * instance();
     ...
     Toke_DalSegno();
     Toke_DalSegno(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_Caesura * instance();
     ...
     Toke_Caesura();
     Toke_Caesura(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_ListSep * instance();
     ...
     Toke_ListSep();
     Toke_ListSep(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_MsgName * instance();
     ...
     Toke_MsgName();
     Toke_MsgName(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_BooleanOp * instance();
     ...
     Toke_BooleanOp();
     Toke_BooleanOp(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_AlSegno * instance();
     ...
     Toke_AlSegno();
     Toke_AlSegno(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_DynPiano * instance();
     ...
     Toke_DynPiano();
     Toke_DynPiano(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_Symbol * instance();
     ...
     Toke_Symbol();
     Toke_Symbol(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_OttavaA * instance();
     ...
     Toke_OttavaA();
     Toke_OttavaA(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_PedalUp * instance();
     ...
     Toke_PedalUp();
     Toke_PedalUp(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_Quarters * instance();
     ...
     Toke_Quarters();
     Toke_Quarters(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_MathOp * instance();
     ...
     Toke_MathOp();
     Toke_MathOp(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_Choard * instance();
     ...
     Toke_Choard();
     Toke_Choard(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_OttavaB * instance();
     ...
     Toke_OttavaB();
     Toke_OttavaB(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
...
public:
    ...
    static     Toke_Crotchets * instance();
     ...
     Toke_Crotchets();
     Toke_Crotchets(wstring * s, size_t n);
    SkoarToke* match_toke(wstring * buf, size_t offs) override;
};
