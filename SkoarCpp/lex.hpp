// ======================================================================
// lex.cpp - Generated by Code_Cpp_Lexer on 2018-12-13 00:16:19 for C++14
// ======================================================================
#pragma once
...
public:
    ...
    SkoarStyles::EStyle style;
     ...
     SkoarToke();
     SkoarToke(std::wstring s, size_t offs, size_t n);
    virtual      ~SkoarToke();
...
public:
     ...
     Toke_Eof();
     ~Toke_Eof() override;
    static     size_t burn(std::wstring * buf, size_t offs);
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_AUGen(std::wstring s, size_t offs, size_t n);
     ~Toke_AUGen() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_AUGenWithArgs(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_AlCoda(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Bars(std::wstring s, size_t offs, size_t n);
     ~Toke_Bars() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_BooleanAnd(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_BooleanOr(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_BracketE(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_BracketS(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Carrot(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Cat(std::wstring s, size_t offs, size_t n);
     ~Toke_Cat() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_Choard(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_CmpEqNeq(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_CmpGtLt(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Coda(std::wstring s, size_t offs, size_t n);
     ~Toke_Coda() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_Comment(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_CondE(std::wstring s, size_t offs, size_t n);
     ~Toke_CondE() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_CondIf(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_CondS(std::wstring s, size_t offs, size_t n);
     ~Toke_CondS() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_Crotchets(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_DUGen(std::wstring s, size_t offs, size_t n);
     ~Toke_DUGen() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_DUGenWithArgs(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Deref(std::wstring s, size_t offs, size_t n);
     ~Toke_Deref() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_Duration(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Eighths(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_ExactBeat(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_ExactRest(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_ExpoartsE(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_ExpoartsS(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Fairy(std::wstring s, size_t offs, size_t n);
     ~Toke_Fairy() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_False(std::wstring s, size_t offs, size_t n);
     ~Toke_False() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_Float(std::wstring s, size_t offs, size_t n);
     ~Toke_Float() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_Freq(std::wstring s, size_t offs, size_t n);
     ~Toke_Freq() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_HashLevel(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Int(std::wstring s, size_t offs, size_t n);
     ~Toke_Int() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_KUGen(std::wstring s, size_t offs, size_t n);
     ~Toke_KUGen() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_KUGenWithArgs(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_LWing(std::wstring s, size_t offs, size_t n);
     ~Toke_LWing() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_ListE(std::wstring s, size_t offs, size_t n);
     ~Toke_ListE() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_ListS(std::wstring s, size_t offs, size_t n);
     ~Toke_ListS() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_ListSep(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_LoopE(std::wstring s, size_t offs, size_t n);
     ~Toke_LoopE() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_LoopS(std::wstring s, size_t offs, size_t n);
     ~Toke_LoopS() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_LoopSep(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Lute(std::wstring s, size_t offs, size_t n);
     ~Toke_Lute() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_LuteWithArgs(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_MathOpAddSub(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_MathOpMulDivMod(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_MeditationE(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_MeditationS(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_MsgName(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_MsgNameWithArgs(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_MsgOp(std::wstring s, size_t offs, size_t n);
     ~Toke_MsgOp() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_NamedNoat(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Newline(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Nosey(std::wstring s, size_t offs, size_t n);
     ~Toke_Nosey() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_OctaveShift(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Quarters(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Quavers(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_RWing(std::wstring s, size_t offs, size_t n);
     ~Toke_RWing() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_Semicolon(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_SkoarpionArgs(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_SkoarpionEnd(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_SkoarpionStart(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_String(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Symbol(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_SymbolColon(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_SymbolName(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Times(std::wstring s, size_t offs, size_t n);
     ~Toke_Times() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_True(std::wstring s, size_t offs, size_t n);
     ~Toke_True() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
...
public:
    static const std::wregex rgx;
     ...
     Toke_Tuplet(std::wstring s, size_t offs, size_t n);
...
public:
    static const std::wregex rgx;
     ...
     Toke_Voice(std::wstring s, size_t offs, size_t n);
     ~Toke_Voice() override;
    static     SkoarToke* match_toke(std::wstring * buf, size_t offs);
};
